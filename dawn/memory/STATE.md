...
| Item | Effort | Notes |
|---|---|---|
| **Speaker mis-attribution** | ~2-3 days | Promoted to #1: silent data corruption is the worst-case JARVIS-fiction breakage (Tony asks "what did Pepper say?" and gets Rhodey's words). Extraction prompt biases toward the conversation's first speaker; assistant-turn events get mis-attributed (Case 10 in CAT2_TEMPORAL.md: Jolene's pendant became Deborah's). Correctness > everything else on this list. |
